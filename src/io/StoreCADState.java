...
//		System.out.println(shapes);
		...
		List<Class<? extends Shape>> shapeTypesin = (List<Class<? extends Shape>>) ois.readObject();
		Circle.deserializeStaticState(ois);
		Square.deserializeStaticState(ois);
		Line.deserializeStaticState(ois);
		List<Shape> shapesin = (List<Shape>) ois.readObject();
	 ...
	 * Output: [class Circlecolor[3] xPos[58] yPos[55] dim[93] , 
